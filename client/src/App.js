...
import UserProfile from "./components/AfterLogin/UserProfile/UserProfile"
import Dms from "./components/AfterLogin/Dms"
	...
	return (
		<AnimatePresence exitBeforeEnter>
			<Switch>
				...
				<Route path="/dms/:userid">
					<UserProfile />
				</Route>

				<Route exact path="/dms">
					<TopNav />
					<Dms />
					<BottomNav />
				</Route>
